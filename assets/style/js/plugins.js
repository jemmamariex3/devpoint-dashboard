...
(function (e, t, n) {
  ...
  e.fn.dropdownHover = function (n) {
    ...
    return this.each(function () {
      var i = e(this), s = i.parent(), o = {delay: 500, instantlyCloseOthers: !0}, u = {
...
!function (a, b, c, d) {
  ...
  var g = {
    ...
    _main: function (b, c, d) {
      ...
      }()), "bottomToTop" === e.options.displayType && (b = 0, e.blocks.css({opacity: 0, marginTop: 80}), function j() {
      ...
      var a = this;
      a._duplicateContent({top: "-100%", opacity: 0}), a.transitionByFilter = "css", a.$ul.addClass("cbp-wrapper-front")
      ...
      var a = this;
      a._duplicateContent({left: "100%", opacity: 0}), a.$ulClone.addClass("no-trans"), a.transitionByFilter = "css"
...
!function (a, b) {
  ...
  var c = "Layers." + b.SliderPro.namespace, d = {
    ...
    layersDefaults: {
      waitForLayers: !1, autoScaleLayers: !0, autoScaleReference: -1, showLayersComplete: function () {
...
(function (e, t) {
  ...
  var v = function (t, n) {
    ...
    if (n.navigationArrows != "none" && n.navigationArrows != "nexttobullets") {
      ...
      }); else if (c == "bottom")o.css({top: "auto", bottom: 0 + v + "px"}); else if (c == "top")o.css({
        bottom: "auto",
        top: 0 + v + "px"
      });
      if (h == "center")o.css({
      ...
      }); else if (p == "bottom")u.css({top: "auto", bottom: 0 + g + "px"}); else if (p == "top")u.css({
        bottom: "auto",
        top: 0 + g + "px"
      });
      if (d == "center")u.css({
